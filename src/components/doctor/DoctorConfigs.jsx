  ...
  return (
    ...
    <section className="text-gray-600 body-font">
      ...
      {!loading && configuraciones ? (
        <div className="bg-white min-h-[600px] flex flex-col h-full lg:px-16">
            ...
            <div>
              ...
              <div className="flex flex-col gap-8">
                <Alert
                  ...
                  icon={<IoIosWarning />}
                >
                  Para poder actualizar las configuraciones debe tener en cuenta
                  que no puede tener citas agendadas en los nuevos horarios que
                  quiera establecer.
                </Alert>
                <div>
