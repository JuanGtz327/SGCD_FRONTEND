  ...
  return (
    <>
      <div className="flex flex-col h-full">
        <div className="h-4/5">
          <Card shadow={false} className="w-[28%] px-5 py-5 mx-auto mt-10">
            <Typography
              variant="h3"
              color="blue-gray"
            ...
            <form className="mt-4 mb-2 w-[100%]" onSubmit={onSubmit}>
              <div
                className={`mb-4 flex flex-col gap-6 ${step != 0 && "hidden"}`}
              >
                <Input
                  size="lg"
                  label="Nombre"
              ...
              <div
                className={`mb-4 flex flex-col gap-6 ${step != 2 && "hidden"}`}
              >
                <Textarea
