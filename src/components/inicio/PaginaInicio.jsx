...
import fondo from "../../assets/a.svg";
import img1 from "../../assets/citas.png";
import img2 from "../../assets/clinica.png";
import img3 from "../../assets/configuraciones.png";
...
const posts = [
  {
    title: "Calendario dinámico",
    description:
      " SGCD cuenta con un calendario dinámico que te permite visualizar tus citas de manera rápida y sencilla.",
    imageUrl: img1,
  },
  {
    ...
    <>
      <div>
        <header className="absolute inset-x-0 top-0 z-50">
          <nav
            className="flex items-center justify-between p-6 lg:px-16 2xl:py-24"
            aria-label="Global"
          >
          ...
          >
            ...
            <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-azure-500 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-white/10">
        ...
        <div className="relative isolate overflow-hidden h-[calc(100vh)] mx-0">
      ...
      <div className="relative isolate overflow-hidden bg-azure-500 py-24 sm:py-32">
        <div
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto  lg:mx-0">
            <div className="flex justify-between gap-10">
              ...
              <img
                src="https://cdn.pixabay.com/photo/2014/11/27/20/12/doctor-548133_1280.jpg"
                alt=""
                className="w-[500px] object-cover rounded-xl shadow-xl "
              />
            </div>
          </div>
        </div>
              ...
              >
                ...
                <div className="max-w-xl">
                  <div className="group relative">
                    <h3 className="mt-12 text-lg font-semibold leading-6 text-gray-900 group-hover:text-gray-600">
                      <a href={post.href}>
        ...
        <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
          ...
          <div className="mt-8 md:order-1 md:mt-0">
            <p className="text-center text-xs leading-5">
              &copy; 2023 SGCD, Inc. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
