      ...
      <div>
        <header className="absolute inset-x-0 top-0 z-50">
          ...
          >
            ...
            <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-blue-500 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-white/10">
        ...
        <div className="relative isolate overflow-hidden pt-14 h-[calc(100vh)] ">
          <img
          ...
          <div className="absolute inset-0 flex justify-center items-center">
            ...
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              ...
              <div className="text-center bg-blue-200/70 py-10 rounded-3xl">
                <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">
                  Sistema de Gestion Clinica para Doctores
                </h1>
                <Typography variant="h5" className="mt-5 text-gray-900">
